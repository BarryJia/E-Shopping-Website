...
<head>
    ...
    <link rel="stylesheet" href="MyStyles/sstyle.css">
    </head>
    <body>
                    ...
                    <div class="box"><!--  box Begin    -->
                        ...
                        <form action="confirm.php?update_id=<?php echo $order_id; ?>" method="post" enctype="multipart/form-data"><!--  form Begin    -->
                            ...
                            <div class="form-group"><!--  form-group Begin    -->
                                ...
                                <select name="payment_mode" class="form-control"><!--  form-control Finish    -->
                            ...
                            <div class="form-group"><!--  form-group Begin    -->
                                ...
                                <label> Paypall / Payonner / Western Union Code: </label>
                        ...
                        if(isset($_POST['confirm_payment'])){
                            ...
                            $insert_payment = "insert into payments_new (invoice_no,amount,payment_mode,ref_no,code,payment_date) values ('$invoice_no','$amount','$payment_mode','$ref_no','$code','$payment_date')";
