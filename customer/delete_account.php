...
if(isset($_POST['Yes'])){
    ...
    $delete_customer = "delete from customers where customer_eamil='$c_email'";
    ...
    if($run_delete_customer){
        ...
        echo "<script>alert('Successfully dele your account, feel sorry about this, Good Bye')</script>";
